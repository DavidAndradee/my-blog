...
export default function SobreMim() {
    return (
        <PostModelo fotoCapa={fotoCapa} titulo="Sobre Mim">
            <h3 className={styles.subtitulo}>Olá, um pouco sobre mim.</h3>
            ...
            <p className={styles.paragrafo}>
                Conhecimentos solido e experiência na análise de Requisitos e de Sistemas, crucial para garantir que o produto final atenda às expectativas dos usuários e dos stakeholders.
            </p>
            <p className={styles.paragrafo}>
                Experiência avançada em desenvolvimento ágil, com capacidade de adaptação a mudanças e colaboração proativa e eficaz em equipes multifuncionais. Profundo entendimento dos requisitos do projeto, demonstrando habilidade para analisar e interpretar detalhadamente as necessidades do cliente.
            </p>
            <p className={styles.paragrafo}>
